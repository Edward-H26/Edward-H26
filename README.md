...
My name is Qiran Hu and I have a degree of Bachelor of Science in Data Science and Information Science with minors in Computer Science and Statistics at the University of Illinois At Urbana-Champaign. I am passionate about the intersection of data science, machine learning, and computer vision. I aim to contribute to creating robust systems that learn and adapt efficiently with minimal human supervision and limited datasets by developing and applying advanced machine learning and generative models to address a range of complex tasks. These include the synthesis of realistic data, enhancing 3D scene understanding by computational systems, and extracting actionable insights from diverse datasets. 
...
* **🖥️ Full Professional Proficiency:** Python, C++, R, SQL, NoSQL, GraphQL, HTML, CSS, Javascript, Microsoft Suites, and Adobe Creative Suite.
* **💻 Professional Working Proficiency:** React JS, Node JS, Angular, PHP, and Ruby.
* **⌨️ Limited Working Proficiency:** Java, Cloud DevOps, Unity, SAS, Figma, Canva, and Arduino UNO.
